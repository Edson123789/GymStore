...
<main class="main">
    ...
    <!-- <div class="row p-5" style="background-color: #161615;">
        @foreach ($best as $item)
        <div class="col-md-4">
            <div class="banner banner-image" style="background-color: #161615;">
    ...
    <div class="row mx-auto my-auto text-center" style="background-color: #000; background-size: contain;">
        ...
        <a class="carousel-control-prev text-end" href="#myCarousell" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" style="color: #fff !important; font-size: xlarge;" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#myCarousell" role="button" data-slide="next">
            <span class="carousel-control-next-icon" style="background-color: #000 !important; font-size: xlarge;" aria-hidden="true"></span>
        ...
        <!-- <div class="row">
            <div class="col-12">
                <a class="carousel-control-prev"  href="#myCarousell" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" style="background-color: #000 !important; font-size: xlarge;" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#myCarousell" role="button" data-slide="next">
                    <span class="carousel-control-next-icon" style="background-color: #000 !important; font-size: xlarge;" aria-hidden="true"></span>
